...
void chat1::on_pb_connexion_clicked()
{
...
void chat1::on_pb_envoyer_clicked()
{
    QByteArray paquet;
...
void chat1::on_le_message_returnPressed()
{
    on_pb_envoyer_clicked();
}

void chat1::donneesrecues()
{
